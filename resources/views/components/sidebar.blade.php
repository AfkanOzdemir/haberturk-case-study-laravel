<div class="bg-red-500 w-16 relative font-poppins">
    <div class="w-16 h-screen bg-white fixed z-50 border-r border-[#D9D9D9]">
        <div class="w-full h-1/6 bg-primary-100 relative flex items-start justify-center p-3">
            <a href="/">
                <img src="{{ asset('icons/logo-white.svg') }}" alt="logo" class="w-14 h-14">
            </a>
        </div>
        ...
        <div class="sidebar-background w-full absolute top-0 bg-primary-100 -z-10 h-1/6 transition-all ease-in-out duration-200"></div>
    </div>
    <x-mega-sidebar />
</div>
